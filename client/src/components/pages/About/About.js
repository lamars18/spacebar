    ...
    <div id="about-page" className="container">
      <div className="row">
        ...
        <div className="col-12">
          ...
          <p>SpaceBar is a networking tool for technologists to connect, exchange ideas, and stay current on technology trends.  Other "networks" allow sharing of coding issues but do not promote networking to identify potential collaborators on projects, meetups, speaking engagement, etc.</p>
        </div>
        <div className="col"></div>
      </div>
